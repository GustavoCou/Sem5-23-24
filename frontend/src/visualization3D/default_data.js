...
export const mazeData = [{
    ...
    url: "../assets/mazes/A/floorA1.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/A/floorA2.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/B/floorB1.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/B/floorB2.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/B/floorB3.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/C/floorC1.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/C/floorC2.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/C/floorC3.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/C/floorC4.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/D/floorD1.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/D/floorD2.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/D/floorD3.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
    url: "../assets/mazes/D/floorD4.json",
    credits: "floor  designed by Gustavo Couto.",
    scale: new THREE.Vector3(1.0, 0.5, 1.0)
}, {
...
export const cameraData = {
    view: "fixed", // Fixed view: "fixed"; first-person view: "first-person"; third-person view: "third-person"; top view: "top"; mini-mapper: "mini-mapper"
